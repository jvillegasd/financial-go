      ...
      <div class="fixed overflow-x-hidden overflow-y-auto inset-0 z-40 flex justify-center items-center" >
        <div class="relative mx-auto w-auto max-w-2xl">
          <div class="bg-white w-20 modal rounded-2xl flex flex-col items-center justify-center space-y-6">
            ...
            <p class="text-center font-bold text-2xl">Edit wallet</p>
                ...
                <div :class="['wallet', 'shadow-md', 'rounded-2xl', 'space-y-2', 'z-30', walletCssClass]">
                  <div class="wallet-header flex justify-between items-center pl-8 pr-6 pt-4">
                    ...
                    <div class="text-left">
                      ...
                      <h1 class="title-h1 text-white text-xl font-bold truncate">{{ walletData.name }}</h1>
                    </div>
                  ...
                  <div class="wallet-content flex justify-between items-center px-8">
                    ...
                    <div class="text-left">
                      <label class="wallet-label text-xs font-medium">Amount</label>
                      <h2 class="amount-show text-white text-xl font-bold truncate">{{ walletData.amount }}</h2>
                    </div>
                    ...
                    <div class="text-left">
                      ...
                      <h2 class="text-white text-xl font-bold">{{ walletData.date }}</h2>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    selectColor: function (optionPressed) {
      this.walletData.selectedColor = optionPressed;
    }
  },
  computed: {
    walletCssClass: function () {
      return `bg-grad-${this.walletData.selectedColor}`;
    }
  }
};
</script>
