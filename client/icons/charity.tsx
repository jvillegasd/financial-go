const CharityIcon = ({
  ...
  return (
    ...
    >
      <path d="m265.8 329.7-97.6-97.3a46.8 46.8 0 0 0-66 0 46.3 46.3 0 0 0 0 65.7l97.7 97.3 66-65.7z" fill="#FF6E78" />
      <path
        d="M117.8 245.3c6.1-6 16-6 22 0l56.9 56.6c6 6 6 15.8 0 21.9-6.1 6-16 6-22 0l-56.9-56.6c-6-6-6-15.9 0-22z"
        fill="#F15561"
      />
      <path d="m201.2 331-77-76.7a46.8 46.8 0 0 0-65.9 0 46.3 46.3 0 0 0 0 65.7l77 76.7 66-65.7z" fill="#FF9199" />
      <path
      ...
      <path
        ...
        fill="#FFA6AD"
      />
      <path d="M179.2 328.3h88a22 22 0 1 1 0 43.8h-88a22 22 0 1 1 0-43.8z" fill="#FF9099" />
      <path d="M443 295.5c0-42.4-44.2-76.7-98.9-76.7-54.6 0-99 34.3-99 76.7h198z" fill="#FFC1C6" />
      <path d="M212.2 240.7h186.9v109.5H212.2a54.9 54.9 0 1 1 0-109.5z" fill="#FFA6AD" />
      <path
      ...
      <path
        ...
        fill="#FFBB2A"
      />
      <path d="M131.2 119.6a52 52 0 1 0 .2-104.1 52 52 0 0 0-.2 104z" fill="#FFC343" />
      <path
      ...
      <path
        ...
        fill="#FFC32B"
      />
      <path d="M281.2 171.5a58.6 58.6 0 1 0 .2-117.1 58.6 58.6 0 0 0-.2 117.1z" fill="#FFC83D" />
      <path
      ...
      <path
        ...
        fill="#5F7BCE"
      />
      <path d="M410 262.6c6.2 0 11 5 11 11v87.6a11 11 0 0 1-21.9 0v-87.6c0-6 5-11 11-11z" fill="#3F60C4" />
    </svg>
  );
};
